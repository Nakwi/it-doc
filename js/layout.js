...
(function buildLayout() {
  ...
  const categoryIcons = {
    ...
    'powershell': '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>'
  };
    ...
    <header class="header">
      <div class="header-inner">
        <a href="${base}index.html" class="logo">
          <img src="${base}images/it-doc.svg" alt="IT-DOC" class="logo-mark" width="32" height="34" />
  ...
  document.body.insertAdjacentHTML('beforeend', '<div class="site-version">IT-DOC</div>');
