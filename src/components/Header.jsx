    ...
    <header className="sticky top-0 z-50 h-16 bg-[var(--color-bg-primary)] border-b border-[var(--color-border)]">
      <div className="h-full px-4 lg:px-6 flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden p-2 rounded-lg hover:bg-[var(--color-bg-secondary)]"
        >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-[var(--color-bg-primary)] border-b border-[var(--color-border)] p-4 shadow-lg">
          ...
          <nav className="flex flex-col gap-2">
            <a href="/" className="px-3 py-2 rounded-lg text-sm font-medium text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-secondary)]">
              Accueil
            </a>
            <a href="/a-propos" className="px-3 py-2 rounded-lg text-sm font-medium text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-secondary)]">
              A propos
            </a>
            <button
              onClick={toggleTheme}
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-secondary)]"
            >
